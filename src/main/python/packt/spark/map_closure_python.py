...
if __name__ == "__main__":
    ...
    words_rdd = sparksession.sparkContext.parallelize(words)  # Creation of Spark data structure

    wordLengths = words_rdd.map(lambda word: len(word))  # passing a closure to Spark's `map`
